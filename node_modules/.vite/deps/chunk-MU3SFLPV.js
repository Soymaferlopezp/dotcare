...
var InvalidHexBooleanError2 = class extends BaseError2 {
  constructor(hex) {
...
async function call(client, args) {
  var _a, _b, _c, _d;
  const { account: account_ = client.account, authorizationList, batch = Boolean((_a = client.batch) == null ? void 0 : _a.multicall), blockNumber, blockTag = "pending", accessList, blobs, blockOverrides, code, data: data_, factory, factoryData, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value, stateOverride, ...rest } = args;
  const account = account_ ? parseAccount(account_) : void 0;
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-QGOBL6AC.js");
...
*/
//# sourceMappingURL=chunk-MU3SFLPV.js.map
